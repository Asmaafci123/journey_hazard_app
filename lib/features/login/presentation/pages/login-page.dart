...
//   validate Password
  ...
  _scan() async {
    await FlutterBarcodeScanner.scanBarcode(
      ...
      Scaffold.of(context).showSnackBar(SnackBar(content: Text(translator.translate('sendData'))));
                            ...
                            children: <Widget>[
                              TextFormField(
                                ...
                                onChanged: (String val) {
                                  this.user?.shipmentId = shipmentIdController.text.toString();
                                },
                              ),
                ...
                Padding(
                    ...
                    child:Align(
                      child:FlatButton(
                        ...
                        child: Text(translator.translate('qrcodeText'),
                          style: TextStyle(  fontFamily: FONT_FAMILY,fontWeight: FontWeight.w600,fontSize: 18),
                        ),
                      ),
